...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    public function orderValidate($trx_id = false, $amount = 0, $currency = "BDT", $post_data=false)
    {
        //dd($trx_id);
        if ($post_data == null && $trx_id == null && !is_array($post_data)) {
    ...
    protected function SSLCOMMERZ_hash_varify($store_passwd =false, $post_data=false)
    {
