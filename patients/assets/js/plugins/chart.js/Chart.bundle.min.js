!(function (t, e) {
            ...
            (a.rgb.hsl = function (t) {
                ...
                (a.hsl.hcg = function (t) {
                    var e,
                        ...
                        i = t[2] / 100,
                        a = 0;
                    return (e = i < 0.5 ? 2 * n * i : 2 * n * (1 - i)) < 1 && (a = (i - 0.5 * e) / (1 - e)), [t[0], 100 * e, 100 * a];
                }),
    ...
    var s = o,
        ...
        u = {
            ...
            getAlpha: function (t) {
                var e = d(t);
                return e ? e[3] : (e = h(t)) ? e[3] : (e = c(t)) ? e[3] : void 0;
            },
    ...
    (x.prototype = {
        ...
        (x.prototype.spaces = { rgb: ["red", "green", "blue"], hsl: ["hue", "saturation", "lightness"], hsv: ["hue", "saturation", "value"], hwb: ["hue", "whiteness", "blackness"], cmyk: ["cyan", "magenta", "yellow", "black"] }),
        (x.prototype.maxes = { rgb: [255, 255, 255], hsl: [360, 100, 100], hsv: [360, 100, 100], hwb: [360, 100, 100], cmyk: [100, 100, 100, 100] }),
    ...
    var _,
        ...
        k = {
            ...
            each: function (t, e, n, i) {
                ...
                else if (k.isObject(t)) for (r = (o = Object.keys(t)).length, a = 0; a < r; a++) e.call(n, t[o[a]], o[a]);
            },
        ...
        I = {
            ...
            roundedRect: function (t, e, n, i, a, r) {
                if (r) {
                    ...
                    t.moveTo(e, l),
                        s < u && l < d
                            ? (t.arc(s, l, o, -C, -O), t.arc(u, l, o, -O, 0), t.arc(u, d, o, 0, O), t.arc(s, d, o, O, C))
                            : s < u
                            ? (t.moveTo(s, n), t.arc(u, l, o, -O, O), t.arc(s, l, o, O, C + O))
                            : l < d
                            ? (t.arc(s, l, o, -C, 0), t.arc(s, d, o, 0, C))
                            : t.arc(s, l, o, -C, C),
                        t.closePath(),
                        t.moveTo(e, n);
                } else t.rect(e, n, i, a);
                    ...
                    switch ((t.beginPath(), e)) {
                        ...
                        case "rectRounded":
                            (u = n - (d = 0.516 * n)),
                                (s = Math.cos(h + A) * u),
                                (l = Math.sin(h + A) * u),
                                t.arc(i - s, a - l, d, h - C, h - O),
                                t.arc(i + l, a - s, d, h - O, h),
                                t.arc(i + s, a + l, d, h, h + O),
                                t.arc(i - l, a + s, d, h + O, h + C),
                                t.closePath();
                            break;
                        case "rect":
                            if (!r) {
        ...
        Y = {
            ...
            _parseFont: function (t) {
                var e = N.global,
                    ...
                    i = { family: W(t.fontFamily, e.defaultFontFamily), lineHeight: M.options.toLineHeight(W(t.lineHeight, e.defaultLineHeight), n), size: n, style: W(t.fontStyle, e.defaultFontStyle), weight: null, string: "" };
                return (
                    (i.string = (function (t) {
    ...
    V.extend(G.prototype, {
        ...
        (G.extend = V.inherits);
    var q = G,
        Z = q.extend({ chart: null, currentStep: 0, numSteps: 60, easing: "", render: null, onAnimationProgress: null, onAnimationComplete: null }),
        $ = Z;
    Object.defineProperty(Z.prototype, "animationObject", {
        ...
        N._set("global", { animation: { duration: 1e3, easing: "easeOutQuart", onProgress: V.noop, onComplete: V.noop } });
    var X = {
            animations: [],
            request: null,
    ...
    V.extend(tt.prototype, {
        ...
        setHoverStyle: function (t) {
            ...
            (t.$previousStyle = { backgroundColor: a.backgroundColor, borderColor: a.borderColor, borderWidth: a.borderWidth }),
                (a.backgroundColor = K([i.hoverBackgroundColor, e.hoverBackgroundColor, r(a.backgroundColor)], void 0, n)),
                (a.borderColor = K([i.hoverBorderColor, e.hoverBorderColor, r(a.borderColor)], void 0, n)),
                (a.borderWidth = K([i.hoverBorderWidth, e.hoverBorderWidth, a.borderWidth], void 0, n));
        },
    ...
    var at = q.extend({
            ...
            inRange: function (t, e) {
                var n = this._view;
                if (n) {
                    for (var i = V.getAngleFromPoint(n, { x: t, y: e }), a = i.angle, r = i.distance, o = n.startAngle, s = n.endAngle; s < o; ) s += nt;
                    for (; a > s; ) a -= nt;
                    for (; a < o; ) a += nt;
                    var l = a >= o && a <= s,
            ...
            draw: function () {
                var t,
                    ...
                    a = { x: n.x, y: n.y, innerRadius: n.innerRadius, outerRadius: Math.max(n.outerRadius - i, 0), pixelMargin: i, startAngle: n.startAngle, endAngle: n.endAngle, fullCircles: Math.floor(n.circumference / nt) };
                if ((e.save(), (e.fillStyle = n.backgroundColor), (e.strokeStyle = n.borderColor), a.fullCircles)) {
                    for (a.endAngle = a.startAngle + nt, e.beginPath(), e.arc(a.x, a.y, a.outerRadius, a.startAngle, a.endAngle), e.arc(a.x, a.y, a.innerRadius, a.endAngle, a.startAngle, !0), e.closePath(), t = 0; t < a.fullCircles; ++t)
                        e.fill();
                                ...
                                n.fullCircles &&
                                    (function (t, e, n, i) {
                                        var a,
                                            r = n.endAngle;
                                        for (
                                            i && ((n.endAngle = n.startAngle + nt), it(t, n), (n.endAngle = r), n.endAngle === n.startAngle && n.fullCircles && ((n.endAngle += nt), n.fullCircles--)),
                                                t.beginPath(),
                                                t.arc(n.x, n.y, n.innerRadius, n.startAngle + nt, n.startAngle, !0),
                                                a = 0;
                                            a < n.fullCircles;
                                            ++a
                                        )
                                            t.stroke();
                                        for (t.beginPath(), t.arc(n.x, n.y, e.outerRadius, n.startAngle, n.startAngle + nt), a = 0; a < n.fullCircles; ++a) t.stroke();
                                    })(t, e, n, i),
                                i && it(t, n),
                                t.beginPath(),
        ...
        rt = V.valueOrDefault,
        ot = N.global.defaultColor;
    N._set("global", { elements: { line: { tension: 0.4, backgroundColor: ot, borderWidth: 3, borderColor: ot, borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", capBezierPoints: !0, fill: !0 } } });
    var st = q.extend({
            _type: "line",
            draw: function () {
                var t,
    ...
    N._set("global", { elements: { point: { radius: 3, pointStyle: "circle", backgroundColor: ut, borderColor: ut, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } } });
    var ht = q.extend({
            _type: "point",
            inRange: function (t, e) {
                var n = this._view;
            ...
            draw: function (t) {
                ...
                e.skip ||
                    ((void 0 === t || V.canvas._isPointInArea(e, t)) &&
                        ((n.strokeStyle = e.borderColor || u), (n.lineWidth = lt(e.borderWidth, l.elements.point.borderWidth)), (n.fillStyle = e.backgroundColor || u), V.canvas.drawPoint(n, i, r, o, s, a)));
            },
        }),
    ...
    function gt(t) {
        var e, n, i, a, r;
        return (
            ft(t) ? ((r = t.width / 2), (e = t.x - r), (n = t.x + r), (i = Math.min(t.y, t.base)), (a = Math.max(t.y, t.base))) : ((r = t.height / 2), (e = Math.min(t.x, t.base)), (n = Math.max(t.x, t.base)), (i = t.y - r), (a = t.y + r)),
    ...
    N._set("global", { elements: { rectangle: { backgroundColor: ct, borderColor: ct, borderSkipped: "bottom", borderWidth: 0 } } });
    var vt = q.extend({
            _type: "rectangle",
            draw: function () {
            ...
            inLabelRange: function (t, e) {
                var n = this._view;
                return ft(n) ? pt(n, t, null) : pt(n, null, e);
            },
            inXRange: function (t) {
    ...
    var St = et.extend({
            ...
            initialize: function () {
                ...
                et.prototype.initialize.apply(n, arguments),
                    ...
                    kt("bar chart", e.barPercentage, "scales.[x/y]Axes.barPercentage", "dataset.barPercentage"),
                    kt("bar chart", e.barThickness, "scales.[x/y]Axes.barThickness", "dataset.barThickness"),
                    kt("bar chart", e.categoryPercentage, "scales.[x/y]Axes.categoryPercentage", "dataset.categoryPercentage"),
                    kt("bar chart", n._getValueScale().options.minBarLength, "scales.[x/y]Axes.minBarLength", "dataset.minBarLength"),
                    kt("bar chart", e.maxBarThickness, "scales.[x/y]Axes.maxBarThickness", "dataset.maxBarThickness");
            },
            update: function (t) {
                var e,
                    n,
            ...
            calculateBarValuePixels: function (t, e, n) {
                ...
                return (
                    (o = h.getPixelForValue(y)), (l = (s = h.getPixelForValue(y + x)) - o), void 0 !== p && Math.abs(l) < p && ((l = p), (s = (x >= 0 && !c) || (x < 0 && c) ? o - p : o + p)), { size: l, base: o, head: s, center: s + l / 2 }
                );
            },
            ...
            _resolveDataElementOptions: function () {
                var t = this,
                    e = V.extend({}, et.prototype._resolveDataElementOptions.apply(t, arguments)),
                    n = t._getIndexScale().options,
                    i = t._getValueScale().options;
                return (
                    (e.barPercentage = Mt(n.barPercentage, e.barPercentage)),
                    (e.barThickness = Mt(n.barThickness, e.barThickness)),
                    (e.categoryPercentage = Mt(n.categoryPercentage, e.categoryPercentage)),
                    (e.maxBarThickness = Mt(n.maxBarThickness, e.maxBarThickness)),
                    (e.minBarLength = Mt(i.minBarLength, e.minBarLength)),
                    e
                );
            },
        }),
    ...
    var Pt = et.extend({
            ...
            setHoverStyle: function (t) {
                ...
                (t.$previousStyle = { backgroundColor: e.backgroundColor, borderColor: e.borderColor, borderWidth: e.borderWidth, radius: e.radius }),
                    (e.backgroundColor = Dt(n.hoverBackgroundColor, i(n.backgroundColor))),
            ...
            _resolveDataElementOptions: function (t, e) {
                ...
                return n._cachedDataOpts === s && (s = V.extend({}, s)), (s.radius = Ct([r.radius, o.r, n._config.radius, i.options.elements.point.radius], l, e)), s;
            },
        }),
        Tt = V.valueOrDefault,
        Ot = Math.PI,
    ...
    var It = et.extend({
        ...
        update: function (t) {
            ...
            if (p < At) {
                var b = l.rotation % At,
                    ...
                    S = (b <= Ft && y >= Ft) || y >= At + Ft,
                    D = (b <= -Ft && y >= -Ft) || y >= Ot + Ft,
                    C = b === -Ot || y >= Ot ? -1 : Math.min(x, x * m, w, w * m),
        ...
        updateElement: function (t, e, n) {
            var i = this,
                ...
                h = o.rotation,
                c = i.getDataset(),
                f = n && s.animateRotate ? 0 : t.hidden ? 0 : i.calculateCircumference(c.data[e]) * (o.circumference / At),
    ...
    var zt = et.extend({
            ...
            update: function (t) {
                var e,
                    ...
                    s = i.chart.options,
                    l = i._config,
                    u = (i._showLine = Rt(l.showLine, s.showLines));
                for (
            ...
            updateElement: function (t, e, n) {
                ...
                (i = h.getPixelForValue("object" == typeof d ? d : NaN, e, u)),
                    ...
                    (t._model = {
                        ...
                        tension: Rt(s.tension, f ? f.tension : 0),
            ...
            _resolveDatasetElementOptions: function (t) {
                ...
                return (
                    (o.spanGaps = Rt(n.spanGaps, a.spanGaps)),
                    (o.tension = Rt(n.lineTension, r.tension)),
                    (o.steppedLine = Nt([i.steppedLine, n.steppedLine, r.stepped])),
                    (o.clip = (function (t) {
                        var e, n, i, a;
                        ...
                        Rt(
                            ...
                            })(e._xScale, e._yScale, o.borderWidth)
                        )
                    )),
                    o
                );
            ...
            updateBezierControlPoints: function () {
                ...
                if (a.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t)
                        (n = l[t]._model),
                            Wt(n, s) &&
                                (t > 0 && Wt(l[t - 1]._model, s) && ((n.controlPointPreviousX = u(n.controlPointPreviousX, s.left, s.right)), (n.controlPointPreviousY = u(n.controlPointPreviousY, s.top, s.bottom))),
                                t < l.length - 1 && Wt(l[t + 1]._model, s) && ((n.controlPointNextX = u(n.controlPointNextX, s.left, s.right)), (n.controlPointNextY = u(n.controlPointNextY, s.top, s.bottom))));
            },
            draw: function () {
                var t,
                    e = this.chart,
            ...
            setHoverStyle: function (t) {
                ...
                (t.$previousStyle = { backgroundColor: e.backgroundColor, borderColor: e.borderColor, borderWidth: e.borderWidth, radius: e.radius }),
                    ...
                    (e.radius = Rt(n.hoverRadius, n.radius));
            },
        }),
        Et = V.options.resolve;
    N._set("polarArea", {
    ...
    var jt = et.extend({
        ...
        _resolveDatasetElementOptions: function () {
            var t = this,
                e = t._config,
                n = t.chart.options,
                i = et.prototype._resolveDatasetElementOptions.apply(t, arguments);
            return (i.spanGaps = Bt(e.spanGaps, n.spanGaps)), (i.tension = Bt(e.lineTension, n.elements.line.tension)), i;
        },
        updateBezierControlPoints: function () {
            var t,
                e,
        ...
        setHoverStyle: function (t) {
            var e = t._model,
                ...
                i = V.getHoverColor;
            (t.$previousStyle = { backgroundColor: e.backgroundColor, borderColor: e.borderColor, borderWidth: e.borderWidth, radius: e.radius }),
                (e.backgroundColor = Bt(n.hoverBackgroundColor, i(n.backgroundColor))),
                    ...
                    var i = t.options.layout || {},
                        ...
                        s = (function (t) {
                            var e = (function (t) {
                                ...
                                a = ee(te(e, "top"), !0),
                                r = ee(te(e, "bottom"));
                            return { leftAndTop: n.concat(a), rightAndBottom: i.concat(r), chartArea: te(e, "chartArea"), vertical: n.concat(i), horizontal: a.concat(r) };
                        })(t.boxes),
                        l = s.vertical,
                        u = s.horizontal,
                        d = Object.freeze({ outerWidth: e, outerHeight: n, padding: a, availableWidth: r, vBoxMaxWidth: r / 2 / l.length, hBoxMaxHeight: o / 2 }),
                        h = Qt({ maxPadding: Qt({}, a), w: r, h: o, x: a.left, y: a.top }, a);
                    !(function (t, e) {
                        var n, i, a;
            ...
            return n && n.canvas === t
                ? (this._ensureLoaded(t),
                  (function (t, e) {
                      ...
                      if (((t[de] = { initial: { height: i, width: a, style: { display: n.display, height: n.height, width: n.width } } }), (n.display = n.display || "block"), null === a || "" === a)) {
                          var r = pe(t, "width");
                          void 0 !== r && (t.width = r);
                      }
                      if (null === i || "" === i)
                ...
                !(function (t, e, n) {
                    var i,
                        ...
                        l = (s.resizer = (function (t) {
                            ...
                            return be(n, "scroll", a.bind(n, "expand")), be(i, "scroll", a.bind(i, "shrink")), e;
                        })(
                            ((i = function () {
                                if (s.resizer) {
                                    var i = n.options.maintainAspectRatio && t.parentNode,
                                        a = i ? i.clientWidth : 0;
                                    e(xe("resize", n)), i && i.clientWidth < a && n.canvas && e(xe("resize", n));
                                }
                            }),
                            (r = !1),
                            (o = []),
    ...
    (V.addEvent = be), (V.removeEvent = ye);
    var ke = we._enabled
            ? we
            : {
        ...
        Me = V.extend({ initialize: function () {}, acquireContext: function () {}, releaseContext: function () {}, addEventListener: function () {}, removeEventListener: function () {} }, ke);
    ...
    var Se = {
                ...
                return (
                    this._plugins.concat(a.plugins || []).forEach(function (t) {
                        if (-1 === n.indexOf(t)) {
                            var e = t.id,
                                a = r[e];
                            !1 !== a && (!0 === a && (a = V.clone(N.global.plugins[e])), n.push(t), i.push({ plugin: t, options: a || {} }));
                        }
                    }),
                    (e.descriptors = i),
                    (e.id = this._cacheId),
        ...
        De = {
            ...
            getScaleDefaults: function (t) {
                return this.defaults.hasOwnProperty(t) ? V.merge({}, [N.scale, this.defaults[t]]) : {};
            },
    ...
    var Re = q.extend({
            initialize: function () {
                (this._model = Fe(this._options)), (this._lastActive = []);
            },
            getTitle: function () {
                var t = this,
                    ...
                    r = [];
                return (r = Oe(r, Ae(n))), (r = Oe(r, Ae(i))), Oe(r, Ae(a));
            },
            ...
            getBody: function (t, e) {
                ...
                return (
                    V.each(t, function (t) {
                        ...
                        Oe(r.before, Ae(i.beforeLabel.call(n, t, e))), Oe(r.lines, i.label.call(n, t, e)), Oe(r.after, Ae(i.afterLabel.call(n, t, e))), a.push(r);
                    }),
                    a
                );
            },
            ...
            update: function (t) {
                ...
                if (m.length) {
                    ...
                    var _ = [],
                        w = [];
                    x = Te[c.position].call(h, m, h._eventPosition);
                    var k = [];
                    for (e = 0, n = m.length; e < n; ++e)
                        k.push(
                            ...
                            (o = i._index),
                            (s = i._datasetIndex),
                            (u = (l = i._chart.getDatasetMeta(s).controller)._getIndexScale()),
                            (d = l._getValueScale()),
                            {
            ...
            drawBody: function (t, e, n) {
                ...
                for (
                    ...
                    for (i = g[s], a = e.labelTextColors[s], r = e.labelColors[s], n.fillStyle = a, V.each(i.before, y), l = 0, d = (o = i.lines).length; l < d; ++l) {
                        if (m) {
                            var _ = b.x(v);
                ...
                (p = 0), V.each(e.afterBody, y), (t.y -= c);
            },
                ...
                if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                        (o = n[t][a]),
                            ...
                            !e[t][a].type || (o.type && o.type !== e[t][a].type) ? V.merge(e[t][a], [De.getScaleDefaults(r), o]) : V.merge(e[t][a], o);
    ...
    function Ee() {
        return V.merge({}, [].slice.call(arguments), {
            merger: function (t, e, n, i) {
                var a = e[t] || {},
                    r = n[t];
                "scales" === t ? (e[t] = ze(a, r)) : "scale" === t ? (e[t] = V.merge(a, [De.getScaleDefaults(r.type), r])) : V._merger(t, e, n, i);
            },
        });
    }
    function Ve(t, e, n) {
    ...
    V.extend(je.prototype, {
        construct: function (t, e) {
            ...
            e = (function (t) {
                ...
                return (e.datasets = e.datasets || []), (e.labels = e.labels || []), (t.options = Ee(N.global, N[t.type], t.options || {})), t;
            })(e);
        ...
        initialize: function () {
            var t = this;
            return Se.notify(t, "beforeInit"), V.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.initToolTip(), Se.notify(t, "afterInit"), t;
        },
        clear: function () {
        ...
        resize: function (t) {
            ...
            if ((e.width !== r || e.height !== o) && ((i.width = e.width = r), (i.height = e.height = o), (i.style.width = r + "px"), (i.style.height = o + "px"), V.retinaScale(e, n.devicePixelRatio), !t)) {
                ...
                Se.notify(e, "resize", [s]), n.onResize && n.onResize(e, s), e.stop(), e.update({ duration: n.responsiveAnimationDuration });
            }
        },
        ensureScalesHaveIDs: function () {
            ...
            V.each(e.xAxes, function (t, n) {
                t.id || (t.id = Ve(e.xAxes, "x-axis-", n));
            }),
                V.each(e.yAxes, function (t, n) {
                    t.id || (t.id = Ve(e.yAxes, "y-axis-", n));
                }),
                n && (n.id = n.id || "scale");
        },
            ...
            e.scales &&
                ...
                V.each(i, function (e) {
                    var i = e.options,
                        r = i.id,
                        o = Ye(i.type, e.dtype);
                    He(i.position) !== He(e.dposition) && (i.position = e.dposition), (a[r] = !0);
                    var s = null;
            ...
            if (
                ...
                (function (t) {
                    ...
                    V.each(t.scales, function (e) {
                        ...
                        (e = Ee(N.global, N[t.config.type], e)),
        ...
        updateDataset: function (t) {
            var e = this.getDatasetMeta(t),
                n = { meta: e, index: t };
            !1 !== Se.notify(this, "beforeDatasetUpdate", [n]) && (e.controller._update(), Se.notify(this, "afterDatasetUpdate", [n]));
        },
        render: function (t) {
            var e = this;
            (t && "object" == typeof t) || (t = { duration: t, lazy: arguments[1] });
            ...
            if (!1 !== Se.notify(e, "beforeRender")) {
                var r = function (t) {
                    Se.notify(e, "afterRender"), V.callback(n && n.onComplete, [t], e);
                };
                if (n && i) {
                    var o = new $({
                        numSteps: i / 16.66,
        ...
        draw: function (t) {
            var e,
                n,
                i = this;
            if ((i.clear(), V.isNullOrUndef(t) && (t = 1), i.transition(t), !(i.width <= 0 || i.height <= 0) && !1 !== Se.notify(i, "beforeDraw", [t]))) {
        ...
        drawDataset: function (t, e) {
            ...
            !1 !== Se.notify(this, "beforeDatasetDraw", [n]) && (t.controller.draw(e), Se.notify(this, "afterDatasetDraw", [n]));
        },
        _drawTooltip: function (t) {
            var e = this.tooltip,
                n = { tooltip: e, easingValue: t };
            !1 !== Se.notify(this, "beforeTooltipDraw", [n]) && (e.draw(), Se.notify(this, "afterTooltipDraw", [n]));
        },
        ...
        destroy: function () {
            ...
            i && (n.unbindEvents(), V.canvas.clear(n), Me.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)), Se.notify(n, "destroy"), delete je.instances[n.id];
        },
        ...
        initToolTip: function () {
            var t = this;
            t.tooltip = new We({ _chart: t, _chartInstance: t, _data: t.data, _options: t.options.tooltips }, t);
        },
        bindEvents: function () {
            var t = this,
                e = (t._listeners = {}),
        ...
        eventHandler: function (t) {
            ...
            if (!1 !== Se.notify(e, "beforeEvent", [t])) {
                ...
                n && (i = n._start ? n.handleEvent(t) : i | n.handleEvent(t)), Se.notify(e, "afterEvent", [t]);
    ...
    function an(t, e) {
        return V.extend(V.options._parseFont({ fontFamily: Je(e.fontFamily, t.fontFamily), fontSize: Je(e.fontSize, t.fontSize), fontStyle: Je(e.fontStyle, t.fontStyle), lineHeight: Je(e.lineHeight, t.lineHeight) }), {
            color: V.options.resolve([e.fontColor, t.fontColor, N.global.defaultFontColor]),
        });
    }
    function rn(t) {
        var e = an(t, t.minor);
    ...
    N._set("scale", {
        ...
        ticks: { beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: $e.formatters.values, minor: {}, major: {} },
    });
    var ln = q.extend({
        zeroLineIndex: 0,
        getPadding: function () {
        ...
        afterBuildTicks: function (t) {
            var e = this;
            return Xe(t) && t.length ? V.callback(e.options.afterBuildTicks, [e, t]) : ((e.ticks = V.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks), t);
        },
            ...
            !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
                ...
                : ((e = (t = s._getLabelSizes()).widest.width),
                  ...
                  e + 6 > (a = l.offset ? s.maxWidth / d : i / (d - 1)) &&
                      ...
                      (r = s.maxHeight - en(l.gridLines) - u.padding - nn(l.scaleLabel)),
                      (o = Math.sqrt(e * e + n * n)),
        ...
        fit: function () {
            var t = this,
                ...
                l = "bottom" === i.position,
                u = t.isHorizontal();
            if ((u ? (e.width = t.maxWidth) : s && (e.width = en(o) + nn(r)), u ? s && (e.height = en(o) + nn(r)) : (e.height = t.maxHeight), a.display && s)) {
                var d = rn(a),
                    h = t._getLabelSizes(),
                    c = h.first,
                    f = h.last,
                ...
                e ||
                    ((t._labelSizes = e = (function (t, e, n, i) {
                        var a,
                            ...
                            x = [];
                        for (a = 0; a < v; ++a) {
                            if (((s = n[a].label), (l = n[a].major ? e.major : e.minor), (t.font = u = l.string), (d = i[u] = i[u] || { data: {}, gc: [] }), (h = l.lineHeight), (c = f = 0), Ke(s) || Xe(s))) {
                                if (Xe(s)) for (r = 0, o = s.length; r < o; ++r) (g = s[r]), Ke(g) || Xe(g) || ((c = V.measureText(t, d.data, d.gc, c, g)), (f += h));
        ...
        _parseValue: function (t) {
            var e, n, i, a;
            return (
                Xe(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)),
        ...
        _autoSkip: function (t) {
            ...
            if (
                ...
                return (a = u > 1 ? (h - d) / (u - 1) : null), sn(t, i, V.isNullOrUndef(a) ? 0 : d - a, d), sn(t, i, h, V.isNullOrUndef(a) ? t.length : h + a), on(t);
            }
            return sn(t, i), on(t);
        },
        _tickSize: function () {
        ...
        _computeGridLineItems: function (t) {
            var e,
                ...
                C = en(_),
                P = [],
                T = _.drawBorder ? Qe(_.lineWidth, 0, 0) : 0,
                O = T / 2,
                A = V._alignPixel,
                F = function (t) {
                    return A(y, t, T);
                ...
                (i = S[n] || {}),
                    (Ke(i.label) && n < S.length) ||
                        (n === b.zeroLineIndex && x.offset === k
                            ...
                            : ((g = Qe(_.lineWidth, n, 1)), (m = Qe(_.color, n, "rgba(0,0,0,0.1)")), (p = _.borderDash || []), (v = _.borderDashOffset || 0)),
                        void 0 !== (a = tn(b, i._index || n, k)) &&
        ...
        _drawGrid: function (t) {
            ...
            if (n.display) {
                var i,
                    ...
                    u = e.chart,
                    d = V._alignPixel,
                    h = n.drawBorder ? Qe(n.lineWidth, 0, 0) : 0,
                ...
                if (h) {
                    var f,
                        ...
                        p,
                        v = h,
                        b = Qe(n.lineWidth, c.ticksLength - 1, 1),
                        y = c.borderValue;
        ...
        _drawTitle: function () {
            ...
            if (i.display) {
                var a,
                    r,
                    o = Je(i.fontColor, N.global.defaultFontColor),
        ...
        hn = un.extend({
            ...
            _configure: function () {
                var t = this,
                    e = t.options.offset,
                    n = t.ticks;
                un.prototype._configure.call(t), t.isHorizontal() || (t._reversePixels = !t._reversePixels), n && ((t._startValue = t.minIndex - (e ? 0.5 : 0)), (t._valueRange = Math.max(n.length - (e ? 0 : 1), 1)));
            },
            getPixelForValue: function (t, e, n) {
                var i,
                    ...
                    o = this;
                return (
                    dn(e) || dn(n) || (t = o.chart.data.datasets[n].data[e]),
                    dn(t) || (i = o.isHorizontal() ? t.x : t.y),
    ...
    hn._defaults = { position: "bottom" };
    var cn = V.noop,
        fn = V.isNullOrUndef,
        gn = un.extend({
            getRightValue: function (t) {
                return "string" == typeof t ? +t : un.prototype.getRightValue.call(this, t);
            },
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        var n,
                            ...
                            f = e.min,
                            g = e.max,
                            m = V.niceNum((g - f) / u / l) * l;
                        if (m < 1e-14 && fn(d) && fn(h)) return [f, g];
                        (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = V.niceNum((r * m) / u / l) * l),
                            s || fn(c) ? (n = Math.pow(10, V._decimalPlaces(m))) : ((n = Math.pow(10, c)), (m = Math.ceil(m * n) / n)),
                            (i = Math.floor(f / m) * m),
                            (a = Math.ceil(g / m) * m),
                            s && (!fn(d) && V.almostWhole(d / m, m / 1e3) && (i = d), !fn(h) && V.almostWhole(h / m, m / 1e3) && (a = h)),
                            (r = (a - i) / m),
                            (r = V.almostEquals(r, Math.round(r), m / 1e3) ? Math.round(r) : Math.ceil(r)),
                            (i = Math.round(i * n) / n),
                            (a = Math.round(a * n) / n),
                            o.push(fn(d) ? i : d);
                        for (var p = 1; p < r; ++p) o.push(Math.round((i + p * m) * n) / n);
                        return o.push(fn(h) ? a : h), o;
                    })(i, t));
            ...
            convertTicksToLabels: function () {
                var t = this;
                (t.ticksAsNumbers = t.ticks.slice()), (t.zeroLineIndex = t.ticks.indexOf(0)), un.prototype.convertTicksToLabels.call(t);
            },
            _configure: function () {
                var t,
                    e = this,
                    ...
                    i = e.min,
                    a = e.max;
                un.prototype._configure.call(e), e.options.offset && n.length && ((i -= t = (a - i) / Math.max(n.length - 1, 1) / 2), (a += t)), (e._startValue = i), (e._endValue = a), (e._valueRange = a - i);
            },
        }),
        mn = { position: "left", ticks: { callback: $e.formatters.linear } };
    function pn(t, e, n, i) {
        var a,
            r,
            o = t.options,
    ...
    var bn = gn.extend({
            determineDataLimits: function () {
                ...
                for (t = 0; t < d; ++t) (n = o[(e = s[t]).index].data), l ? pn(a, u, e, n) : vn(a, e, n);
                V.each(u, function (t) {
        ...
        yn = mn;
    bn._defaults = yn;
    var xn = V.valueOrDefault,
        _n = V.math.log10,
        wn = { position: "left", ticks: { callback: $e.formatters.logarithmic } };
    function kn(t, e) {
    ...
    var Mn = un.extend({
            ...
            handleTickRangeOptions: function () {
                ...
                (t.min = kn(e.min, t.min)),
                    ...
                    t.min === t.max && (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(_n(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(_n(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
                    null === t.min && (t.min = Math.pow(10, Math.floor(_n(t.max)) - 1)),
                    null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(_n(t.min)) + 1) : 10),
                    null === t.minNotZero && (t.min > 0 ? (t.minNotZero = t.min) : t.max < 1 ? (t.minNotZero = Math.pow(10, Math.floor(_n(t.max)))) : (t.minNotZero = 1));
            },
            buildTicks: function () {
                var t = this,
                    e = t.options.ticks,
                    ...
                    a = (t.ticks = (function (t, e) {
                        var n,
                            i,
                            a = [],
                            r = xn(t.min, Math.pow(10, Math.floor(_n(e.min)))),
                            o = Math.floor(_n(e.max)),
                            s = Math.ceil(e.max / Math.pow(10, o));
                        0 === r ? ((n = Math.floor(_n(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), a.push(r), (r = i * Math.pow(10, n))) : ((n = Math.floor(_n(r))), (i = Math.floor(r / Math.pow(10, n))));
            ...
            convertTicksToLabels: function () {
                (this.tickValues = this.ticks.slice()), un.prototype.convertTicksToLabels.call(this);
            },
            getLabelForIndex: function (t, e) {
                return this._getScaleLabel(this.chart.data.datasets[e].data[t]);
            },
            ...
            _configure: function () {
                ...
                un.prototype._configure.call(t),
                    0 === e && ((e = t._getFirstTickValue(t.minNotZero)), (n = xn(t.options.ticks.fontSize, N.global.defaultFontSize) / t._length)),
                    (t._startValue = _n(e)),
                    (t._valueOffset = n),
                    (t._valueRange = (_n(t.max) - _n(e)) / (1 - n));
            },
            getPixelForValue: function (t) {
                var e = this,
                    n = 0;
                return (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (_n(t) - e._startValue) / e._valueRange + e._valueOffset), e.getPixelForDecimal(n);
            },
            getValueForPixel: function (t) {
                var e = this,
    ...
    var Dn = V.valueOrDefault,
        Cn = V.valueAtIndexOrDefault,
        Pn = V.options.resolve,
        Tn = {
            display: !0,
            animate: !0,
            position: "chartArea",
            ...
            ticks: { showLabelBackdrop: !0, backdropColor: "rgba(255,255,255,0.75)", backdropPaddingY: 2, backdropPaddingX: 2, callback: $e.formatters.linear },
            pointLabels: {
                display: !0,
                fontSize: 10,
                callback: function (t) {
    ...
    function On(t) {
        var e = t.ticks;
        return e.display && t.display ? Dn(e.fontSize, N.global.defaultFontSize) + 2 * e.backdropPaddingY : 0;
    }
    ...
    var Nn = gn.extend({
                    ...
                    ? (function (t) {
                          ...
                          for (e = 0; e < d; e++) {
                              ...
                              var h = t.getIndexAngle(e),
                                  c = V.toDegrees(h) % 360,
                                  f = An(c, i.x, n.w, 0, 180),
                                  g = An(c, i.y, n.h, 90, 270);
            ...
            setReductions: function (t, e, n) {
                ...
                (a = Rn(a)), (r = Rn(r)), (o = Rn(o)), (s = Rn(s)), (i.drawingArea = Math.min(Math.floor(t - (a + r) / 2), Math.floor(t - (o + s) / 2))), i.setCenterPoint(a, r, o, s);
            },
                ...
                if (
                        ...
                        (function (t) {
                            ...
                            for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                                var l = 0 === s ? a / 2 : 0,
                                    ...
                                    d = Cn(i.fontColor, s, N.global.defaultFontColor);
                                e.fillStyle = d;
                                var h = t.getIndexAngle(s),
                                    c = V.toDegrees(h);
                                (e.textAlign = Fn(c)), Ln(c, t._pointLabelSizes[s], u), In(e, t.pointLabels[s], u, o.lineHeight);
                            }
                            e.restore();
                        })(i),
                    o.display &&
                    ...
                    for (
                        a.save(),
                            a.lineWidth = l,
                            a.strokeStyle = u,
                            a.setLineDash && (a.setLineDash(Pn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Pn([s.borderDashOffset, o.borderDashOffset, 0]))),
            ...
            _drawLabels: function () {
                ...
                if (n.display) {
                    var i,
                        ...
                        s = Dn(n.fontColor, N.global.defaultFontColor);
                    e.save(),
                        (e.font = o.string),
    ...
    function Kn(t, e, n, i) {
        var a,
            ...
            o,
            s = jn.length;
        for (a = jn.indexOf(t); a < s - 1; ++a) if (((o = (r = Bn[jn[a]]).steps ? r.steps : Hn), r.common && Math.ceil((n - e) / (o * r.size)) <= i)) return jn[a];
        return jn[s - 1];
    }
    function Jn(t, e, n) {
        var i,
    ...
    var Qn = un.extend({
        ...
        update: function () {
            var t = this,
                e = t.options,
                n = e.time || (e.time = {}),
                i = (t._adapter = new Ze._date(e.adapters.date));
            return (
        ...
        getRightValue: function (t) {
            return t && void 0 !== t.t && (t = t.t), un.prototype.getRightValue.call(this, t);
        },
        determineDataLimits: function () {
            var t,
                e,
                ...
                p = [],
                v = s._getLabels();
            for (t = 0, n = v.length; t < n; ++t) p.push(Xn(s, v[t]));
            for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
                if (l.isDatasetVisible(t))
                    if (((a = l.data.datasets[t].data), V.isObject(a[0]))) for (m[t] = [], e = 0, i = a.length; e < i; ++e) (r = Xn(s, a[e])), g.push(r), (m[t][e] = r);
            ...
            p.length && ((c = Math.min(c, p[0])), (f = Math.max(f, p[p.length - 1]))),
                ...
                (c = Xn(s, Gn(d)) || c),
                (f = Xn(s, qn(d)) || f),
                (c = c === Hn ? +u.startOf(Date.now(), h) : c),
                (f = f === Vn ? +u.endOf(Date.now(), h) + 1 : f),
                (s.min = Math.min(c, f)),
        ...
        buildTicks: function () {
            ...
            return (
                ...
                (i._unit =
                    l.unit ||
                    (s.autoSkip
                        ? Kn(l.minUnit, i.min, i.max, h)
                        : (function (t, e, n, i, a) {
                              var r, o;
                              for (r = jn.length - 1; r >= jn.indexOf(n); r--) if (((o = jn[r]), Bn[o].common && t._adapter.diff(a, i, o) >= e - 1)) return o;
                              return jn[n ? jn.indexOf(n) : 0];
                          })(i, d.length, l.minUnit, i.min, i.max))),
                (i._majorUnit =
                    s.major.enabled && "year" !== i._unit
                        ? (function (t) {
                              for (var e = jn.indexOf(t) + 1, n = jn.length; e < n; ++e) if (Bn[jn[e]].common) return jn[e];
                          })(i._unit)
                        : void 0),
                (i._table = (function (t, e, n, i) {
                    if ("linear" === f || !t.length)
                        return [
                            { time: e, pos: 0 },
                            { time: n, pos: 1 },
                        ];
                ...
                (i._offsets = (function (t, e, n, i, a) {
                    ...
                    return (
                        a.offset &&
                            e.length &&
                            ((r = Zn(t, "time", e[0], "pos")),
                            (s = 1 === e.length ? 1 - r : (Zn(t, "time", e[1], "pos") - r) / 2),
                            (o = Zn(t, "time", e[e.length - 1], "pos")),
                            (l = 1 === e.length ? o : (o - Zn(t, "time", e[e.length - 2], "pos")) / 2)),
        ...
        getLabelForIndex: function (t, e) {
            ...
            return V.isObject(s) && (o = n.getRightValue(s)), r.tooltipFormat ? i.format($n(n, o), r.tooltipFormat) : "string" == typeof o ? o : i.format($n(n, o), r.displayFormats.datetime);
        },
        tickFormatFunction: function (t, e, n, i) {
            var a = this._adapter,
                ...
                g = c ? h.major : h.minor,
                m = zn([g.callback, g.userCallback, h.callback, h.userCallback]);
            return m ? m(f, e, n) : f;
        },
        ...
        getPixelForValue: function (t, e, n) {
            var i = null;
            if ((void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = Xn(this, t)), null !== i)) return this.getPixelForOffset(i);
        },
        getPixelForTick: function (t) {
            var e = this.getTicks();
        ...
        _getLabelSize: function (t) {
            var e = this.options.ticks,
                ...
                a = Math.cos(i),
                r = Math.sin(i),
                o = En(e.fontSize, N.global.defaultFontSize);
    ...
    var ti = { category: hn, linear: bn, logarithmic: Mn, radialLinear: Nn, time: Qn },
        ei = t(function (t, e) {
            t.exports = (function () {
                var e, n;
                function i() {
                ...
                function v(t, e) {
                    ...
                    if (
                        ...
                        for (n = 0; n < p.length; n++) o((a = e[(i = p[n])])) || (t[i] = a);
                    return t;
                }
                var b = !1;
                function y(t) {
                ...
                var D,
                    C = {};
                function P(t, e) {
                    null != i.deprecationHandler && i.deprecationHandler(t, e), C[t] || (M(e), (C[t] = !0));
                }
                function T(t) {
                ...
                function U(t, e) {
                    ...
                    for (E.lastIndex = 0; n >= 0 && E.test(t); ) (t = t.replace(E, i)), (E.lastIndex = 0), (n -= 1);
                    return t;
                }
                var G = /\d/,
                    q = /\d\d/,
                ...
                B("Y", 0, 0, function () {
                    ...
                    ft("YYYY", function (t, e) {
                        e[pt] = 2 === t.length ? i.parseTwoDigitYear(t) : w(t);
                    }),
                    ft("YY", function (t, e) {
                ...
                function At(t, e, n) {
                    t.isValid() &&
                        !isNaN(n) &&
                        ("FullYear" === e && Dt(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](n, t.month(), Ft(n, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](n));
                }
                function Ft(t, e) {
                ...
                function Nt(t, e) {
                    ...
                    return (n = Math.min(t.date(), Ft(t.year(), e))), t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, n), t;
                }
                function Wt(t) {
                    return null != t ? (Nt(this, t), i.updateOffset(this, !0), this) : Ot(this, "Month");
                }
                var Yt = st,
                    zt = st;
                function Et() {
                ...
                function Ht(t, e, n) {
                    var i = 7 + e - n;
                    return (-(7 + Vt(t, 0, i).getUTCDay() - e) % 7) + i - 1;
                }
                function Bt(t, e, n, i, a) {
                    var r,
                        o,
                        s = 1 + 7 * (e - 1) + ((7 + n - i) % 7) + Ht(t, i, a);
                    return s <= 0 ? (o = St((r = t - 1)) + s) : s > St(t) ? ((r = t + 1), (o = s - St(t))) : ((r = t), (o = s)), { year: r, dayOfYear: o };
                }
                function jt(t, e, n) {
                    var i,
                        a,
                    ...
                    return o < 1 ? (i = o + Ut((a = t.year() - 1), e, n)) : o > Ut(t.year(), e, n) ? ((i = o - Ut(t.year(), e, n)), (a = t.year() + 1)) : ((a = t.year()), (i = o)), { week: i, year: a };
                }
                function Ut(t, e, n) {
                    var i = Ht(t, e, n),
                        a = Ht(t + 1, e, n);
                ...
                B("H", ["HH", 2], 0, "hour"),
                    ...
                    B("hmm", 0, 0, function () {
                        return "" + te.apply(this) + Y(this.minutes(), 2);
                    }),
                    B("hmmss", 0, 0, function () {
                        return "" + te.apply(this) + Y(this.minutes(), 2) + Y(this.seconds(), 2);
                    }),
                    B("Hmm", 0, 0, function () {
                    ...
                    ft(["h", "hh"], function (t, e, n) {
                        (e[yt] = w(t)), (f(n).bigHour = !0);
                    }),
                    ft("hmm", function (t, e, n) {
                        var i = t.length - 2;
                        (e[yt] = w(t.substr(0, i))), (e[xt] = w(t.substr(i))), (f(n).bigHour = !0);
                    }),
                    ft("hmmss", function (t, e, n) {
                        var i = t.length - 4,
                            a = t.length - 2;
                        (e[yt] = w(t.substr(0, i))), (e[xt] = w(t.substr(i, 2))), (e[_t] = w(t.substr(a))), (f(n).bigHour = !0);
                    }),
                    ft("Hmm", function (t, e, n) {
                        var i = t.length - 2;
                        (e[yt] = w(t.substr(0, i))), (e[xt] = w(t.substr(i)));
                    }),
                    ft("Hmmss", function (t, e, n) {
                        var i = t.length - 4,
                            a = t.length - 2;
                ...
                function de(t, e) {
                    var n;
                    return t && ((n = o(e) ? ce(t) : he(t, e)) ? (ie = n) : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")), ie._abbr;
                }
                function he(t, e) {
                    if (null !== e) {
                        var n,
                        ...
                        if (((e.abbr = t), null != oe[t]))
                            ...
                            if (null != oe[e.parentLocale]) i = oe[e.parentLocale]._config;
                                ...
                                if (null == (n = ue(e.parentLocale))) return se[e.parentLocale] || (se[e.parentLocale] = []), se[e.parentLocale].push({ name: t, config: e }), null;
                                i = n._config;
                            }
                        return (
                            (oe[t] = new A(O(i, e))),
                    ...
                    return (
                        n &&
                            ...
                            ((e =
                                n[vt] < 0 || n[vt] > 11
                                    ? vt
                                    : n[bt] < 1 || n[bt] > Ft(n[pt], n[vt])
                                    ? bt
                                    : n[yt] < 0 || n[yt] > 24 || (24 === n[yt] && (0 !== n[xt] || 0 !== n[_t] || 0 !== n[wt]))
                                    ? yt
                                    : n[xt] < 0 || n[xt] > 59
                                    ? xt
                                    : n[_t] < 0 || n[_t] > 59
                                    ...
                                    ? wt
                                    : -1),
                            f(t)._overflowDayOfYear && (e < pt || e > bt) && (e = bt),
                ...
                function me(t) {
                    ...
                    if (!t._d) {
                        for (
                            a = (function (t) {
                                ...
                                t._w &&
                                    ...
                                    (function (t) {
                                        var e, n, i, a, r, o, s, l;
                                        if (null != (e = t._w).GG || null != e.W || null != e.E) (r = 1), (o = 4), (n = ge(e.GG, t._a[pt], jt(Oe(), 1, 4).year)), (i = ge(e.W, 1)), ((a = ge(e.E, 1)) < 1 || a > 7) && (l = !0);
                                        else {
                                            (r = t._locale._week.dow), (o = t._locale._week.doy);
                                            var u = jt(Oe(), r, o);
                                            (n = ge(e.gg, t._a[pt], u.year)), (i = ge(e.w, u.week)), null != e.d ? ((a = e.d) < 0 || a > 6) && (l = !0) : null != e.e ? ((a = e.e + r), (e.e < 0 || e.e > 6) && (l = !0)) : (a = r);
                                        }
                                        i < 1 || i > Ut(n, r, o) ? (f(t)._overflowWeeks = !0) : null != l ? (f(t)._overflowWeekday = !0) : ((s = Bt(n, i, a, r, o)), (t._a[pt] = s.year), (t._dayOfYear = s.dayOfYear));
                                    })(t),
                                null != t._dayOfYear &&
                                    ((o = ge(t._a[pt], a[pt])), (t._dayOfYear > St(o) || 0 === t._dayOfYear) && (f(t)._overflowDayOfYear = !0), (n = Vt(o, 0, t._dayOfYear)), (t._a[vt] = n.getUTCMonth()), (t._a[bt] = n.getUTCDate())),
                                e = 0;
                            e < 3 && null == t._a[e];
                            ++e
                        )
                        ...
                        24 === t._a[yt] && 0 === t._a[xt] && 0 === t._a[_t] && 0 === t._a[wt] && ((t._nextDay = !0), (t._a[yt] = 0)),
                            (t._d = (t._useUTC
                                ? Vt
                ...
                function we(t) {
                    ...
                    if (l) {
                        for (f(t).iso = !0, e = 0, n = ye.length; e < n; e++)
                            if (ye[e][1].exec(l[1])) {
                                (a = ye[e][0]), (i = !1 !== ye[e][2]);
                                break;
                            }
                        ...
                        if (l[4]) {
                            if (!be.exec(l[4])) return void (t._isValid = !1);
                            o = "Z";
                        }
                        (t._f = a + (r || "") + (o || "")), Ce(t);
                    } else t._isValid = !1;
                ...
                var Se = { UT: 0, GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480 };
                function De(t) {
                    var e,
                        n,
                        i,
                    ...
                    if (l) {
                        var u = ((e = l[4]), (n = l[3]), (i = l[2]), (a = l[5]), (r = l[6]), (o = l[7]), (s = [Me(e), Rt.indexOf(n), parseInt(i, 10), parseInt(a, 10), parseInt(r, 10)]), o && s.push(parseInt(o, 10)), s);
                        if (
                            !(function (t, e, n) {
                    ...
                    if (t._f !== i.ISO_8601)
                        if (t._f !== i.RFC_2822) {
                            ...
                            for (a = U(t._f, t._locale).match(z) || [], e = 0; e < a.length; e++)
                                (r = a[e]),
                                    (n = (s.match(dt(r, t)) || [])[0]) && ((o = s.substr(0, s.indexOf(n))).length > 0 && f(t).unusedInput.push(o), (s = s.slice(s.indexOf(n) + n.length)), (u += n.length)),
                                    H[r] ? (n ? (f(t).empty = !1) : f(t).unusedTokens.push(r), mt(r, n, t)) : t._strict && !n && f(t).unusedTokens.push(r);
                            (f(t).charsLeftOver = l - u),
                                s.length > 0 && f(t).unusedInput.push(s),
                                t._a[yt] <= 12 && !0 === f(t).bigHour && t._a[yt] > 0 && (f(t).bigHour = void 0),
                                (f(t).parsedDateParts = t._a.slice(0)),
                                (f(t).meridiem = t._meridiem),
                                (t._a[yt] = (function (t, e, n) {
                                    var i;
                                    return null == n ? e : null != t.meridiemHour ? t.meridiemHour(e, n) : null != t.isPM ? ((i = t.isPM(n)) && e < 12 && (e += 12), i || 12 !== e || (e = 0), e) : e;
                                })(t._locale, t._a[yt], t._meridiem)),
                                me(t),
                                fe(t);
                        } else De(t);
                    else we(t);
                                  ...
                                  : (l(e)
                                        ...
                                        ? (function (t) {
                                              ...
                                              for (a = 0; a < t._f.length; a++)
                                                  (r = 0),
                                                      ...
                                                      (e._f = t._f[a]),
                                                      Ce(e),
                                                      g(e) && ((r += f(e).charsLeftOver), (r += 10 * f(e).unusedTokens.length), (f(e).score = r), (null == i || r < i) && ((i = r), (n = e)));
                                              h(t, n || e);
                                          })(t)
                                        : n
                                        ? Ce(t)
                                        : (function (t) {
                                              ...
                                              o(e)
                                                  ...
                                                  ? (function (t) {
                                                        var e = _e.exec(t._i);
                                                        null === e ? (we(t), !1 === t._isValid && (delete t._isValid, De(t), !1 === t._isValid && (delete t._isValid, i.createFromInputFallback(t)))) : (t._d = new Date(+e[1]));
                                                    })(t)
                                                  : a(e)
                ...
                function Te(t, e, n, i, o) {
                    ...
                    return (
                        ...
                        (l._f = e),
                        (l._strict = i),
                        (s = new y(fe(Pe(l))))._nextDay && (s.add(1, "d"), (s._nextDay = void 0)),
                        s
                    );
                }
                function Oe(t, e, n, i) {
                ...
                function Re(t) {
                    ...
                    (this._isValid = (function (t) {
                        ...
                        for (var n = !1, i = 0; i < Le.length; ++i)
                            if (t[Le[i]]) {
                                if (n) return !1;
                                parseFloat(t[Le[i]]) !== w(t[Le[i]]) && (n = !0);
                            }
                        return !0;
                    })(e)),
                ...
                function Ve(t, e) {
                    var n, a;
                    return e._isUTC ? ((n = e.clone()), (a = (x(t) || l(t) ? t.valueOf() : Oe(t).valueOf()) - n.valueOf()), n._d.setTime(n._d.valueOf() + a), i.updateOffset(n, !1), n) : Oe(t).local();
                }
                function He(t) {
                ...
                function Ge(t, e) {
                    ...
                    return (
                        Ne(t)
                            ...
                            : (h = je.exec(t))
                            ? ((n = "-" === h[1] ? -1 : 1), (u = { y: 0, d: w(h[bt]) * n, h: w(h[yt]) * n, m: w(h[xt]) * n, s: w(h[_t]) * n, ms: w(We(1e3 * h[wt])) * n }))
                            : (h = Ue.exec(t))
                            ? ((n = "-" === h[1] ? -1 : 1), (u = { y: qe(h[2], n), M: qe(h[3], n), w: qe(h[4], n), d: qe(h[5], n), h: qe(h[6], n), m: qe(h[7], n), s: qe(h[8], n) }))
                            : null == u
                            ? (u = {})
                            : "object" == typeof u &&
                              ("from" in u || "to" in u) &&
                              ((r = Oe(u.from)),
                              (o = Oe(u.to)),
                              (a = r.isValid() && o.isValid() ? ((o = Ve(o, r)), r.isBefore(o) ? (l = Ze(r, o)) : (((l = Ze(o, r)).milliseconds = -l.milliseconds), (l.months = -l.months)), l) : { milliseconds: 0, months: 0 }),
                              ((u = {}).ms = a.milliseconds),
                              (u.M = a.months)),
                        (i = new Re(u)),
                        Ne(t) && d(t, "_locale") && (i._locale = t._locale),
                        i
                    );
                }
                function qe(t, e) {
                    ...
                    return function (n, i) {
                        ...
                        return (
                            null === i ||
                                ...
                                (n = i),
                                (i = a)),
                            Xe(this, Ge((n = "string" == typeof n ? +n : n), i), t),
                            this
                        );
                    };
                }
                function Xe(t, e, n, a) {
                    var r = e._milliseconds,
                        o = We(e._days),
                        s = We(e._months);
                    t.isValid() && ((a = null == a || a), s && Nt(t, Ot(t, "Month") + s * n), o && At(t, "Date", Ot(t, "Date") + o * n), r && t._d.setTime(t._d.valueOf() + r * n), a && i.updateOffset(t, o || s));
                }
                (Ge.fn = Re.prototype),
                    (Ge.invalid = function () {
                        return Ge(NaN);
                ...
                (pn.add = Ke),
                    (pn.calendar = function (t, e) {
                        var n = t || Oe(),
                            a = Ve(n, this).startOf("day"),
                            r = i.calendarFormat(this, a) || "sameElse",
                            o = e && (T(e[r]) ? e[r].call(this, n) : e[r]);
                        return this.format(o || this.localeData().calendar(r, this, Oe(n)));
                    }),
                    (pn.clone = function () {
                        return new y(this);
                    }),
                    (pn.diff = function (t, e, n) {
                        ...
                        switch (((a = 6e4 * (i.utcOffset() - this.utcOffset())), (e = L(e)))) {
                            case "year":
                                r = Qe(this, i) / 12;
                                break;
                            case "month":
                    ...
                    (pn.endOf = function (t) {
                        ...
                        switch (t) {
                            ...
                            case "date":
                                ...
                                break;
                            case "hour":
                                (e = this._d.valueOf()), (e += 36e5 - rn(e + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) - 1);
                                break;
                            case "minute":
                    ...
                    (pn.from = function (t, e) {
                        return this.isValid() && ((x(t) && t.isValid()) || Oe(t).isValid()) ? Ge({ to: this, from: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
                    }),
                    (pn.fromNow = function (t) {
                        return this.from(Oe(), t);
                    }),
                    (pn.to = function (t, e) {
                        return this.isValid() && ((x(t) && t.isValid()) || Oe(t).isValid()) ? Ge({ from: this, to: t }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate();
                    }),
                    (pn.toNow = function (t) {
                        return this.to(Oe(), t);
                    }),
                    ...
                    (pn.isSame = function (t, e) {
                        ...
                        return (
                            ...
                            ("millisecond" === (e = L(e) || "millisecond") ? this.valueOf() === i.valueOf() : ((n = i.valueOf()), this.clone().startOf(e).valueOf() <= n && n <= this.clone().endOf(e).valueOf()))
                        );
                    }),
                    ...
                    (pn.startOf = function (t) {
                        ...
                        switch (t) {
                            ...
                            case "date":
                                ...
                                break;
                            case "hour":
                                (e = this._d.valueOf()), (e -= rn(e + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
                                break;
                            case "minute":
                    ...
                    (pn.toISOString = function (t) {
                        ...
                        return n.year() < 0 || n.year() > 9999
                            ? j(n, e ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ")
                            : T(Date.prototype.toISOString)
                            ? e
                                ? this.toDate().toISOString()
                                : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", j(n, "Z"))
                            : j(n, e ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ");
                    }),
                    (pn.inspect = function () {
                    ...
                    (pn.hour = pn.hours = ae),
                    (pn.minute = pn.minutes = hn),
                    (pn.second = pn.seconds = fn),
                    (pn.millisecond = pn.milliseconds = mn),
                    (pn.utcOffset = function (t, e, n) {
                        var a,
                            r = this._offset || 0;
                        if (!this.isValid()) return null != t ? this : NaN;
                        if (null != t) {
                            ...
                            return (
                                !this._isUTC && e && (a = He(this)),
                                (this._offset = t),
                                (this._isUTC = !0),
                                null != a && this.add(a, "m"),
                                r !== t && (!e || this._changeInProgress ? Xe(this, Ge(t - r, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), i.updateOffset(this, !0), (this._changeInProgress = null))),
                                this
                            );
                        }
                    ...
                    (pn.dates = S("dates accessor is deprecated. Use date instead.", dn)),
                    (pn.months = S("months accessor is deprecated. Use month instead", Wt)),
                    (pn.years = S("years accessor is deprecated. Use year instead", Pt)),
                    (pn.zone = S("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function (t, e) {
                        return null != t ? ("string" != typeof t && (t = -t), this.utcOffset(t, e), this) : -this.utcOffset();
                    })),
                    (pn.isDSTShifted = S("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function () {
                        if (!o(this._isDSTShifted)) return this._isDSTShifted;
                        var t = {};
                        if ((v(t, this), (t = Pe(t))._a)) {
                            var e = t._isUTC ? c(t._a) : Oe(t._a);
                ...
                function xn(t, e, n) {
                    if ((s(t) && ((e = t), (t = void 0)), (t = t || ""), null != e)) return yn(t, e, n, "month");
                    var i,
                        a = [];
                    for (i = 0; i < 12; i++) a[i] = yn(t, i, n, "month");
                    return a;
                }
                function _n(t, e, n, i) {
                    ...
                    var a,
                        r = ce(),
                        o = t ? r._week.dow : 0;
                    if (null != n) return yn(e, (n + o) % 7, i, "day");
                    var l = [];
                    for (a = 0; a < 7; a++) l[a] = yn(e, (a + o) % 7, i, "day");
                    return l;
                }
                (bn.calendar = function (t, e, n) {
                    ...
                    (bn.monthsRegex = function (t) {
                        return this._monthsParseExact
                            ? (d(this, "_monthsRegex") || Et.call(this), t ? this._monthsStrictRegex : this._monthsRegex)
                            : (d(this, "_monthsRegex") || (this._monthsRegex = zt), this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex);
                    }),
                    (bn.monthsShortRegex = function (t) {
                        return this._monthsParseExact
                            ? (d(this, "_monthsRegex") || Et.call(this), t ? this._monthsShortStrictRegex : this._monthsShortRegex)
                            : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = Yt), this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex);
                    }),
                    (bn.week = function (t) {
                    ...
                    (bn.weekdaysRegex = function (t) {
                        return this._weekdaysParseExact
                            ...
                            : (d(this, "_weekdaysRegex") || (this._weekdaysRegex = Xt), this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex);
                    }),
                    (bn.weekdaysShortRegex = function (t) {
                        return this._weekdaysParseExact
                            ? (d(this, "_weekdaysRegex") || Qt.call(this), t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
                            : (d(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Kt), this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
                    }),
                    (bn.weekdaysMinRegex = function (t) {
                        return this._weekdaysParseExact
                            ? (d(this, "_weekdaysRegex") || Qt.call(this), t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
                            : (d(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Jt), this._weekdaysMinStrictRegex && t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
                    }),
                    (bn.isPM = function (t) {
                    ...
                    (i.lang = S("moment.lang is deprecated. Use moment.locale instead.", de)),
                    (i.langData = S("moment.langData is deprecated. Use moment.localeData instead.", ce));
                var wn = Math.abs;
                function kn(t, e, n, i) {
                    var a = Ge(e, n);
                ...
                function $n() {
                    ...
                    if (!h) return "P0D";
                    var c = h < 0 ? "-" : "",
                        f = Zn(this._months) !== Zn(h) ? "-" : "",
                        g = Zn(this._days) !== Zn(h) ? "-" : "",
                ...
                return (
                    ...
                    (Xn.as = function (t) {
                        ...
                        if ("month" === (t = L(t)) || "quarter" === t || "year" === t)
                            switch (((e = this._days + i / 864e5), (n = this._months + Sn(e)), t)) {
                                case "month":
                                    return n;
                                case "quarter":
                                    return n / 3;
                    ...
                    (Xn._bubble = function () {
                        var t,
                            ...
                            l = this._data;
                        return (
                            (r >= 0 && o >= 0 && s >= 0) || (r <= 0 && o <= 0 && s <= 0) || ((r += 864e5 * Mn(Dn(s) + o)), (o = 0), (s = 0)),
                    ...
                    (Xn.locale = tn),
                    (Xn.localeData = nn),
                    (Xn.toIsoString = S("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", $n)),
                    (Xn.lang = en),
                    B("X", 0, 0, "unix"),
                    B("x", 0, 0, "valueOf"),
                    ut("x", at),
                    ...
                    (i.updateLocale = function (t, e) {
                        if (null != e) {
                            var n,
                                i,
                                a = re;
                            null != (i = ue(t)) && (a = i._config), ((n = new A((e = O(a, e)))).parentLocale = oe[t]), (oe[t] = n), de(t);
        ...
        ni = { datetime: "MMM D, YYYY, h:mm:ss a", millisecond: "h:mm:ss.SSS a", second: "h:mm:ss a", minute: "h:mm a", hour: "hA", day: "MMM D", week: "ll", month: "MMM YYYY", quarter: "[Q]Q - YYYY", year: "YYYY" };
    Ze._date.override(
        "function" == typeof ei
            ? {
                  _id: "moment",
                  ...
                  parse: function (t, e) {
                      return "string" == typeof t && "string" == typeof e ? (t = ei(t, e)) : t instanceof ei || (t = ei(t)), t.isValid() ? t.valueOf() : null;
                  },
                  format: function (t, e) {
                      return ei(t).format(e);
                  },
                  add: function (t, e, n) {
                      return ei(t).add(e, n).valueOf();
                  },
                  diff: function (t, e, n) {
                      return ei(t).diff(ei(e), n);
                  },
                  startOf: function (t, e, n) {
                      return (t = ei(t)), "isoWeek" === e ? t.isoWeekday(n).valueOf() : t.startOf(e).valueOf();
                  },
                  endOf: function (t, e) {
                      return ei(t).endOf(e).valueOf();
                  },
                  _create: function (t) {
                      return ei(t);
                  },
    ...
    function si(t) {
        var e = t.fill,
            n = "dataset";
        return !1 === e ? null : (isFinite(e) || (n = "boundary"), ii[n](t));
    }
    function li(t) {
        return t && !t.skip;
    }
    ...
    function di(t, e, n, i, a, r) {
        ...
        for (t.beginPath(), o = 0, s = g; o < s; ++o)
            (d = n((u = e[(l = o % g)]._view), l, i)),
                ...
                h && c ? ((b = p.push(u)), (y = v.push(d))) : b && y && (m ? (h && p.push(u), c && v.push(d)) : (ui(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
        ui(t, p, v, b, y), t.closePath(), (t.fillStyle = a), t.fill();
    }
    var hi = {
            id: "filler",
            afterDatasetsUpdate: function (t, e) {
                var n,
                    ...
                    s = e.propagate,
                    l = [];
                for (i = 0; i < o; ++i) (r = null), (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof bt.Line && (r = { visible: t.isDatasetVisible(i), fill: ai(a, i, o), chart: t, el: a }), (n.$filler = r), l.push(r);
                for (i = 0; i < o; ++i) (r = l[i]) && ((r.fill = oi(l, i, s)), (r.boundary = ri(r)), (r.mapper = si(r)));
            },
            beforeDatasetsDraw: function (t) {
                ...
                for (n = l.length - 1; n >= 0; --n)
                    (e = l[n].$filler) &&
                        ...
                        o && s && r.length && (V.canvas.clipArea(u, t.chartArea), di(u, r, o, a, s, i._loop), V.canvas.unclipArea(u)));
            },
        },
        ci = V.rtl.getRtlAdapter,
        fi = V.noop,
        gi = V.valueOrDefault;
    function mi(t, e) {
    ...
    var pi = q.extend({
                ...
                if (((a.font = r.string), u)) {
                    ...
                    (a.textAlign = "left"),
                        ...
                        V.each(t.legendItems, function (t, e) {
                            var i = mi(n, o) + o / 2 + a.measureText(t.text).width;
        ...
        draw: function () {
            ...
            if (e.display) {
                var d,
                    h = ci(e.rtl, t.left, t.minSize.width),
                    c = t.ctx,
                ...
                V.each(t.legendItems, function (e, i) {
                    ...
                    !(function (t, e, i) {
                        if (!(isNaN(p) || p <= 0)) {
                            c.save();
                            var o = gi(i.lineWidth, r.borderWidth);
                            if (
                                ((c.fillStyle = gi(i.fillStyle, a)),
                                (c.lineCap = gi(i.lineCap, r.borderCapStyle)),
                                (c.lineDashOffset = gi(i.lineDashOffset, r.borderDashOffset)),
                                (c.lineJoin = gi(i.lineJoin, r.borderJoinStyle)),
                                (c.lineWidth = o),
                                (c.strokeStyle = gi(i.strokeStyle, a)),
                                c.setLineDash && c.setLineDash(gi(i.lineDash, r.borderDash)),
                                n && n.usePointStyle)
                            ) {
    ...
    var bi = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.legend,
                    n = t.legend;
                e ? (V.mergeIf(e, N.global.legend), n ? (le.configure(t, n, e), (n.options = e)) : vi(t, e)) : n && (le.removeBox(t, n), delete t.legend);
            },
        ...
        draw: function () {
            ...
            if (n.display) {
                var i,
                    ...
                    c = t.bottom,
                    f = t.right;
                (e.fillStyle = V.valueOrDefault(n.fontColor, N.global.defaultFontColor)),
                    (e.font = o.string),
    ...
    function _i(t, e) {
        var n = new xi({ ctx: t.ctx, options: e, chart: t });
    ...
    var wi = {},
        ...
        Si = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.title,
                    n = t.titleBlock;
                e ? (V.mergeIf(e, N.global.title), n ? (le.configure(t, n, e), (n.options = e)) : _i(t, e)) : n && (le.removeBox(t, n), delete t.titleBlock);
            },
        };
    for (var Di in ((wi.filler = ki),
    (wi.legend = Mi),
    (wi.title = Si),
    (Ue.helpers = V),
    (function () {
        ...
        (V.where = function (t, e) {
            ...
            (V.color = w
                ? function (t) {
                      return t instanceof CanvasGradient && (t = N.global.defaultColor), w(t);
                  }
                : function (t) {
    ...
    wi))
        wi.hasOwnProperty(Di) && Ue.plugins.register(wi[Di]);
    Ue.platform.initialize();
    var Ci = Ue;
    return (
        "undefined" != typeof window && (window.Chart = Ue),
        (Ue.Chart = Ue),
        (Ue.Legend = wi.legend._element),
        (Ue.Title = wi.title._element),
        ...
        Ue.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function (t) {
            Ue[t] = function (e, n) {
                return new Ue(e, Ue.helpers.merge(n || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) }));
            };
        }),
        Ci
    );
